...
export const VPGradeLocks = () => {
  ...
  return (
    <div className="p-6 px-4 sm:px-6 lg:px-8 max-w-[95vw] xl:max-w-[1200px] mx-auto">
      <div className="mb-6">
            ...
            {locks.map((lock) => (
              <tr key={lock.courseId} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-center">
                  <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${lock.isLocked
                ...
                <td className="px-6 py-4 text-center">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-colors ${lock.isLocked
