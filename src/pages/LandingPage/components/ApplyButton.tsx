  ...
  return (
    <>
      ...
      <button
        ...
        className={`group relative inline-flex items-center justify-center gap-2.5 rounded-full font-sans font-medium text-sm tracking-wide transition-all duration-300 hover:scale-[1.01] shadow-xl ${
          theme === 'dark'
