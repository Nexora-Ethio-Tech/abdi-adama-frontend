...
export default function FounderMessage() {
  ...
  const foundersData: Founder[] = [
    {
      id: 1,
      name: translations?.founder?.name || "Ato Girma Lemi",
      ...
      On behalf of Abdi Adama School, I extend a heartfelt welcome! I am Ato Girma Lemi, the founder and owner of this remarkable educational institution.
      "To build the future of our children, we must plant the seeds of excellence today."


      Abdi Adama School was established in 1998 E.C. (2005/2006 G.C.), and since that time, we have been diligently working to produce educated, competent, and patriotic citizens for Ethiopia.

      Abdi Adama School made history in Adama City as the first private school to open an instructional section in Afaan Oromoo. We also offer classes in Amharic and English.

      Modern Education Rooted in Culture and Language
      A Historic Milestone: Abdi Adama School made history in Adama City as the first private school to open an instructional section in Afaan Oromoo. This crucial step ensures that children learn profound knowledge in their mother tongue and gain a deep understanding of their culture. Language is the bridge to culture!
      ...
      The mission of Abdi Adama School is to combine modern knowledge with national values and pass this legacy on to the next generation. Our school empowers students to develop comprehensive life skills, build self-confidence, and prepare themselves to be agents of change for the nation. Choose the school where your child will grow with the best teachers, supported by modern educational resources, and nurtured with a hopeful vision for the future.

      Abdi Adama School: Competent Generation for a Brighter Ethiopia!

      Ato Girma Lemi
      Founder and Owner

      Matii Barattotaa, Barattootaa fi jiraattota Magaalaa Adaamaa jaallatamoo,
      Maqaa Mana Barumsaa Abdi Adaamaa tiin Baga Nagayaan dhuftani! Ani Obbo Girmaa Lammiiti, Hundeessaa Dhaabbata Barnoota Guddaa Kanaati.
      "Boru ijoollee keenyaa ijaaruuf, har'a sanyii gaarii facaasuu qabna." Mana Barumsaa Abdi Adaamaa kan hundeeffame bara 1998 A.L.I. yoo ta’u, erga yeroo sanaa kaasee barattoota beekumsa, dandeettii fi jaalala biyyaaf akka horatan qopheessaa tureera.

      Barnoota Ammayyaa Aadaafi Afaaniin Bu'uureffame.
      Seenaa Kan Hojjete: Mana Barumsaa Abdi Adaamaa mana barumsaa dhuunfaa keessatti seenaa hojjeteera. Magaalaa Adaamaatti Afaan Oromoo-tiin kutaa barnootaa banuuf mana barumsaa dhuunfaa jalqabaa ta'eera. Tarkaanfiin kun ijoolleen afaan isaanitiin beekumsa gadifageenyaa akka argataniif, aadaa isaanii sirritti akka beekaniif gumaacha guddaa godheera. Afaan daandii guddinaati!
      ...
      Ergamaan Mana Barumsaa Abdi Adaamaa beekumsa ammayyaa fi duudhaalee biyyaalessaa walitti fiduun dhalootaaf dabarsuudha. Mana barumsaa keenya keessatti barattoonni dandeettii jireenyaa guutuu akka horataniif, ofitti amanamummaa akka ijaaraniif, akkasumas jijjiirama biyyaaf akka of qopheessaniif dandeessisa.
      ...
      Mana Barumsaa Abdi Adaamaa: Dhaloota Beekumsaan Biyyaaf Gumaachu Horuuf!
      ...
      በአብዲ አዳማ ትምህርት ቤት ስም፣ እኔ አቶ ግርማ ለሚ እንኳን ደህና መጣችሁ ማለት እፈልጋለሁ፡፡
      "የልጆቻችንን ነገ ለመገንባት፣ ዛሬ ምርጥ ዘር መትከል አለብን።"
      የላቀ የትምህርት ጉዞ ከ1998 ዓ.ም. ጀምሮ
      አብዲ አዳማ ትምህርት ቤት የተመሠረተው በ1998 ዓ.ም. (2005/2006 G.C.) ሲሆን፣ ከዚያን ጊዜ ጀምሮ ለኢትዮጵያችን ብቁ፣ የተማረ እና ለሀገሩ የሚያስብ ዜጋ በማፍራት ላይ እንገኛለን። እያንዳንዱ ተማሪ የየራሱ ታሪክ ያለው ሲሆን፣ እኛም ያን ታሪክ በዕውቀት ብርሃን እና በብሩህ ተስፋ ለመሙላት ቆርጠናል!

      ባህልን እና ቋንቋን የጠበቀ ዘመናዊ ትምህርት
      የታሪክ ምዕራፍ ፈጣሪ: አብዲ አዳማ ትምህርት ቤት በግል ትምህርት ቤቶች ታሪክ ለመጀመሪያ ጊዜ በአዳማ ከተማ በኦሮሚኛ ቋንቋ (አፋን ኦሮሞ) የትምህርት ክፍል በመክፈት ልጆች በአፍ መፍቻ ቋንቋቸው ጥልቅ ዕውቀት እንዲቀስሙና ባህላቸውን ጠንቅቀው እንዲያውቁ ትልቅ አስተዋፅዖ አድርጓል። ቋንቋ የባህል ድልድይ ነው!
      የሁለት ቋንቋ ጥምረት:
      ...
      ዋና ትኩረታችን
      የአብዲ አዳማ ትምህርት ቤት ተልዕኮ ዘመናዊ ዕውቀትን ከብሔራዊ እሴቶች ጋር አዋህዶ ለትውልድ ማስተላለፍ ነው። ትምህርት ቤታችን ተማሪዎች የተሟላ የሕይወት ክህሎት እንዲያዳብሩ፣ በራስ መተማመን እንዲገነቡ እና ለሀገር ለውጥ ራሳቸውን እንዲያዘጋጁ ያስችላል።
      ልጅዎ ከምርጥ መምህራን ጋር በዘመናዊ የትምህርት ግብዓቶች ታግዞ የሚያድግበትን ብሩህ ተስፋ ያለው ትምህርት ቤት ይምረጡ።

      አብዲ አዳማ ት/ቤት፡ ብቁ ትውልድን ለብሩህ ኢትዮጵያ!
...
Our vision is to inspire each student to think boldly, act responsibly, and dream fearlessly. we thank every parent, teacher, and student who has joined us on this journey — together, we continue building a brighter future for our community.`,
  ...
  return (
    <section ref={ref} className="py-24 md:py-36 bg-zinc-950 flex items-center justify-center overflow-hidden border-t border-zinc-900">
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 max-w-7xl px-6 md:px-12 w-full items-center">
        ...
        <motion.div style={{ x: xLeft, opacity: opacityLeft }} className="text-white order-2 lg:order-1">
          <h2 className="text-xs font-mono tracking-[0.25em] text-blue-400 uppercase mb-4">
            {translations?.founder?.badge || "Founders' Message"}
          </h2>

          <h3 className="text-4xl md:text-5xl font-serif font-medium tracking-tight mb-8 leading-tight text-white">
            {translations?.founder?.titleLine1 || "Words From"}{" "}
            <span className="text-blue-400 block sm:inline">{translations?.founder?.titleLine2 || "Our Leadership"}</span>
          </h3>
          ...
          <div className="min-h-[260px]">
            <AnimatePresence mode="wait">
              ...
              >
                <blockquote className="text-lg md:text-xl text-zinc-400 leading-relaxed font-light italic border-l-2 border-zinc-800 pl-6 mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-8">
            <button
              ...
              className="group flex items-center gap-3 px-8 py-4 rounded-full border border-zinc-700 hover:bg-white hover:text-black transition-all duration-300 font-sans font-light text-sm md:text-base"
            >
            ...
            {foundersData.length > 1 && (
              <div className="flex items-center gap-3">
                <button
                  onClick={handlePrev}
                  className="p-3 rounded-full border border-zinc-800 hover:border-zinc-600 hover:bg-zinc-900 transition-all text-zinc-400 hover:text-white"
        ...
        <motion.div style={{ y: yRight, opacity: opacityRight }} className="relative w-full max-w-md mx-auto order-1 lg:order-2">
          ...
          <div className="relative rounded-3xl shadow-2xl overflow-hidden aspect-[4/5] border border-white/10 group">
            <AnimatePresence mode="wait">
              <motion.img
                key={currentFounder.id}
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-black/60 backdrop-blur-md rounded-2xl p-5 border border-white/10">
              ...
              <p className="text-zinc-400 text-sm font-sans font-light mt-0.5">{currentFounder.role}</p>
            </div>
          </div>
        </motion.div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-hidden">
            ...
            <motion.div
              ...
              className="relative bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl z-10"
            >
              {/* Close Button element */}
              <button
                onClick={() => setIsModalOpen(false)}
                className="absolute top-6 right-6 p-2 rounded-full bg-zinc-800/80 hover:bg-zinc-700 hover:text-white text-zinc-400 transition-all z-20"
              ...
              <div className="overflow-y-auto p-8 md:p-12 space-y-8 custom-scrollbar">
                ...
                <div className="flex items-center gap-5 pb-6 border-b border-zinc-800">
                  ...
                  />
                  <div>
                    <h4 className="text-xl font-serif font-medium tracking-tight text-white">{currentFounder.name}</h4>
                    <p className="text-zinc-400 text-sm font-sans font-light mt-0.5">{currentFounder.role}</p>
                  </div>
                </div>

                {/* Blockquote Segment */}
                <blockquote className="text-lg md:text-xl text-zinc-300 italic border-l-2 border-blue-400 pl-5 py-1 font-light leading-relaxed">
                  "{currentFounder.quote}"
                </blockquote>

                {/* Paragraph Content */}
                <div className="text-zinc-300 text-base md:text-lg font-sans font-light leading-relaxed whitespace-pre-line space-y-4">
                  {currentFounder.text}
                </div>
              </div>
